 ...
 */
public class SmartLogin extends Panel
{
    /**
     * Sign in form.
     */
     ...
     */
    public SmartLogin(final String id)
    {
        this(id, true);
    }
     ...
     * @see org.apache.wicket.Component#Component(String)
     */
    public SmartLogin(final String id, final boolean includeRememberMe)
    {
        super(id);
